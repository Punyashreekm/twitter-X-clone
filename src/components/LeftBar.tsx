...
const LeftBar = () => {
  return (
    <div className="h-screen sticky top-5 flex flex-col justify-between pt-2 pb-8">
      {/* LOGO MENU BUTTON */}
      <div className=" flex flex-col gap-4 text-lg  items-center xxl:items-start">
        ...
        <Link
          href="/compose/post"
          className=" bg-white text-black font-bold rounded-full h-12
         w-12 flex items-center justify-center xxl:hidden"
        >
          <Image path="public/icons/post.svg" alt="new post" w={24} h={24} />
        </Link>
        <Link href="/compose/post" className="hidden xxl:block bg-white text-black font-bold rounded-full py-2 px-20">
          Post
        </Link>
      </div>
      {/* USER */}
      <div className=" flex items-center justify-between">
        <div className=" flex items-center gap-2">
          ...
          <div className="hidden xxl:flex flex-col">
            <span className="font-bold">Punya</span>
            <span className="text-sm text-textGray">@PunyaWebDev</span>
          </div>
        </div>
